...
export default function ProgramaPage() {
  ...
  const day3ActivitiesConferenceRoom: Activity[] = [
    ...
    { time: '9:25 AM a 9:40 AM', title: 'Panel: "La Inteligencia Artificial y el Aprendizaje Universitario"', speakers: 'Profa. Msc. Exira Báez. Universidad de Carabobo', type: 'Panel' },
